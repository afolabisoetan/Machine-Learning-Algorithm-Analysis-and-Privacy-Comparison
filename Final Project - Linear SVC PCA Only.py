...
print("=======================================================================================")
print("Linear SVC Classifier Test (PCA Only Set)")
...
pipeline_svc = Pipeline([
    ...
    ('svc', LinearSVC(class_weight='balanced', dual=False, max_iter=2000)) # Change 2: Use SVC
])
...
print("--- Linear SVC Classification Report (PCA Only Dataset)---")
...
plt.title('Recall Scores - Linear SVC (PCA Only Dataset)')
